...
export default function Footer() {
  ...
  return (
    <>
      <footer className={`bg-background ${hide && "hidden"}`}>
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-start lg:gap-8">
            <div className="text-primary">
              {logo && (
                <img className="md:w-40 object-cover w-10" src={logo} alt="" />
              )}
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-medium text-text">Services</p>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-medium text-text">Helpful Links</p>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-medium text-text">Downloads</p>
