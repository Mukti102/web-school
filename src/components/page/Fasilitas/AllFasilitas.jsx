...
export default function AllFasilitas() {
  ...
  return (
    <React.Fragment>
      <div className="my-0 px-5 sm:px-10 pt-28 sm:pt-32 text-text bg-background">
        <h1 className="sm:font-bold text-xl sm:text-3xl">Semua Fasilitas</h1>
      </div>
      <div className="grid grid-cols-3 pt-5 px-5 sm:px-10 bg-background flex-wrap gap-3 sm:gap-10  w-full">
