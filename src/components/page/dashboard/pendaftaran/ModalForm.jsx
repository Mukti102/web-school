...
export default function ModalForm({ close }) {
  ...
  return (
    <>
      ...
      <div
        data-twe-modal-init
        class="fixed left-0 top-0 z-[1055] hidden bg-black bg-opacity-50  h-full w-full overflow-y-auto overflow-x-hidden outline-none"
      ...
      >
        <div
          ...
          className="pointer-events-none z-[10200] relative flex min-h-[calc(100%-1rem)] w-auto translate-y-[-50px] items-center opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:min-h-[calc(100%-3.5rem)] min-[576px]:max-w-[500px]"
        >
          <form
